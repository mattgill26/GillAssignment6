//name: Matt Gill
//description: Assignment 6 art museum
//proposed points: I propose a score of 15/15 points. The wall is completed and I addeda ceiling. You said in class that a square room was all you were looking for.
//I added mip mapping and point sampling option and allow the user to select which one they would like. 
//For the art I added scream and a sunday. I could have added more art, but I figured it would make the quality of the textures too low.
// I also made the musuem look more modern with white brick walls and dark wood floors.
// 
...
function loadPoints(points,texture) {
    ...
    points.push(vec4(-3.0, 1 , .1, 1));
    texture.push(vec2(0.5, 0));
    points.push(vec4(-3.0 , 4 , .1, 1));
